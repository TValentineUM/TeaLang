...
| `{`          | Block                |
Table: First Token Production Possibilities
...
- `-x` or `--xml` will output the generated XML into a specified file
- `-l` or `--lexer` will output the lexer tokens into a specified file
